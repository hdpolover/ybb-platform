...
| 2026-05-03 | PR #9 - Stats query optimization (`ybb-platform/services/api`) | In progress | Replaced row-loading distinct-country counts with SQL `COUNT(DISTINCT ...)` in stats impact/geography flows and added focused unit coverage. |
