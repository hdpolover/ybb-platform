...
| 2026-05-04 | PR #17 - Admin dashboard platform metrics visibility (`ybb-platform/services/admin-dashboard`) | In progress | Added a new `/platform/metrics` page, wired sidebar navigation entry, and exposed Prometheus metrics via admin API client to render pool/slow-query KPIs plus raw scrape output. PR: TBD |
