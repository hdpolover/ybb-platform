...
connection_url = DATABASE_URL.replace("postgresql://", "postgresql+asyncpg://")
connect_args = {}

if "sslmode=disable" in connection_url:
    connection_url = connection_url.replace("?sslmode=disable", "").replace("&sslmode=disable", "")
