    ...
    items: [
      {
        ...
        children: [
          ...
          { id: "program-testimonies", label: "Testimonies", href: "master-data/program-testimonies", icon: MessageSquare },
          { id: "video-testimonies", label: "Video Testimonies", href: "master-data/video-testimonies", icon: Video },
