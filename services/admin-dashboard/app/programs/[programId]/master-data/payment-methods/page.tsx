...
import { PaymentMethodsTable } from "@/app/components/paymentMethodsMasterData/PaymentMethodsTable";
...
export default function ProgramPaymentMethodsPage({
  params,
}: {
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="space-y-1">
            ...
            <h1 className="text-base font-semibold text-zinc-900 md:text-lg">
              {programName} Payment Methods
            </h1>
            <p className="text-xs text-zinc-500 md:text-sm">
              Manage the payment methods that are available for participants when paying
              registration or program fees.
            </p>
          </div>
        </div>
      </section>
