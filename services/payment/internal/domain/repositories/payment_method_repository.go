...
type PaymentMethodRepository interface {
	...
	// CountByGatewayName returns how many non-soft-deleted payment methods
	// reference the given gateway provider name. Used as a referential-integrity
	// guard before deleting a GatewayConfig.
	CountByGatewayName(ctx context.Context, gatewayName string) (int64, error)
