...
ALTER TABLE gateway_configs ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMP;
CREATE INDEX IF NOT EXISTS idx_gateway_configs_deleted_at ON gateway_configs(deleted_at);
