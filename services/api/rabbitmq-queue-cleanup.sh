...
CLEANUP_ENABLED="${RABBITMQ_QUEUE_CLEANUP_ON_DEPLOY:-false}"
if [ "$CLEANUP_ENABLED" != "true" ]; then
  echo "ℹ️ RabbitMQ queue cleanup skipped (RABBITMQ_QUEUE_CLEANUP_ON_DEPLOY=false)."
  exit 0
fi
...
echo "✅ RabbitMQ queue cleanup finished."
