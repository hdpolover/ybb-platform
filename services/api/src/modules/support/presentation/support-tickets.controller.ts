...
export class SupportTicketsController {
    ...
    async createTicket(
        ...
        const id = await this.commandBus.execute(
            new CreateSupportTicketCommand(user.userId, dto),
        );
        return { id };
    }
    ...
    async listTickets(@CurrentUser() user: CurrentUserData): Promise<SupportTicketResponseDto[]> {
        return this.queryBus.execute(new ListSupportTicketsQuery(user.userId));
    }
    ...
    async getTicket(
        ...
        return this.queryBus.execute(new GetSupportTicketQuery(id, user.userId));
    }
    ...
    async replyTicket(
        ...
        return this.commandBus.execute(
            new ReplySupportTicketCommand(user.userId, id, dto),
        );
    }
}
